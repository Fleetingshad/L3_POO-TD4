...
public abstract class ExtracteurAbstract implements Extracteur{
    ...
    /**
     * Cette méthode permet de savoir si le flux de lecture rencontre un caractère non alphabétique
     * @param c un caractère lu
     * @return true si le caractère lu est un retour chariot, un caractère d'échapemment ou un espace vide
     */
